...
//
//===----------------------------------------------------------------------===//
#ifndef SRC_GTIRB_DECODER_TARGET_RAWX64LOADER_H_
#define SRC_GTIRB_DECODER_TARGET_RAWX64LOADER_H_

#include "../CompositeLoader.h"
#include "../core/DataLoader.h"
#include "../format/RawLoader.h"

CompositeLoader RawX64Loader()
{
...
#endif // SRC_GTIRB_DECODER_TARGET_RAWX64LOADER_H_
