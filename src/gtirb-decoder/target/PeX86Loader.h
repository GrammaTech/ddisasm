...
//
//===----------------------------------------------------------------------===//
#ifndef SRC_GTIRB_DECODER_TARGET_PEX86LOADER_H_
#define SRC_GTIRB_DECODER_TARGET_PEX86LOADER_H_
...
CompositeLoader PeX86Loader()
{
    ...
    //Loader.add(PeExceptionLoader);
    return Loader;
}

#endif // SRC_GTIRB_DECODER_TARGET_PEX86LOADER_H_
