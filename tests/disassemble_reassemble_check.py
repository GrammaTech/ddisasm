...
if __name__ == '__main__':
    ...
    parser.add_argument('--strip', help='strip binaries before disassembling',action='store_true')
    ...
    disassemble_reassemble_test(**{k: v for k, v in args.__dict__.items() if v is not None})