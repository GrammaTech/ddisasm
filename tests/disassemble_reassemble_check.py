...
def binary_print(
    ...
    with contextlib.ExitStack() as stack:
        if MAKE_CHROOT:
            ...
            script_content = (
                "#!/bin/bash\n"
                # Copy intermediate files generated by gcc into the chroot tmp
                # directory, so they exist where they are specified by the
                # arguments generated by gtirb-pprinter.
